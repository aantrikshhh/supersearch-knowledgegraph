...
PRODUCT_TYPE_ALIASES = {
    ...
    "coord": [
        ...
        "coord set", "fusion set", "fusion sets", "ethnic co-ord sets",
        "ethnic co ord sets",
    ],
    ...
    "top": ["tops & shirts", "topwear", "shirt", "blouse", "crop top", "croptop"],
    "lehenga": ["lehengas", "lehenga set", "lehenga sets", "chaniya choli", "ghagra choli", "choli"],
    "jacket": [
        "jackets", "bandi", "bandi set", "bandi sets", "nehru jacket",
        "blazer", "blazers", "tuxedo", "tuxedos", "suit", "suits",
        "kurta jacket set",
    ],
    "skirt": ["skirt set", "skirts"],
    "swimsuit": ["swimwear"],
    "saree": ["sarees", "sari", "pre-draped saree", "pre draped saree", "ready pleated saree"],
